...
function PlayingVideo() {
  ...
  return (
    <div className=" flex justify-center flex-row h-[calc(100%-56px)] mt-16">
      <div className="w-full max-w-[1370px] flex flex-col lg:flex-row">
        <div className="flex flex-col lg:w-[calc(100%-350px)] xl:w-[100%-400px] px-4 py-3 lg:py-6">
          <div className="h-[100px] md:h-[500px] ml-[-16px] mr-[-16px] lg:ml-0 lg:mr-0">
            <ReactPlayer
              ...
              <div className="flex space-x-5">
                <div className="flex flex-col ml-3">
                  ...
                  <div className="flex gap-1 text-sm">
                    {video?.author?.stats?.subscribersText} <p>subscribers</p>
                  </div>
                </div>
